// Tier One Outreach: generic unsubscribe by email address.
// POST {"email": "..."} from https://outreach.benefitsotb.com/unsubscribe.html
// Adds the address to to_suppressed_emails. Returns JSON only: Supabase serves HTML from edge
// functions as text/plain, so the confirm page itself is a static page on the site.
// verify_jwt is off because the person clicking is a consumer, not a signed in associate.
